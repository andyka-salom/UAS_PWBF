...
// Route::get('/tanggalpesan', function () {
//     return view('tanggalpesan');
// });
// Route::get('/pembayaran', function () {
//     return view('pembayaran');
// });
// Route::get('/infopesan', function () {
//     return view('infopesan');
// });
...
Route::get('/detilpesan', function () {
    return view('detilpesan');

});
Route::get('/menubelanja', function () {
    return view('menubelanja');
});
